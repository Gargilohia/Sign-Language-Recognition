...
while True:
    ...
    if num_frames < 60:
        ...
        if num_frames <= 59:
            ...
            cv2.putText(frame_copy, "Collecting the background...", (80, 400), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 300:
                if num_imgs_taken<=39:
                    cv2.imwrite(r'C:\gesture1\Test1\A\\' + str(num_imgs_taken) + '.jpg', thresholded)
                cv2.imwrite(r'C:\gesture1\Train1\A\\' + str(num_imgs_taken) + '.jpg', thresholded)
